...
public abstract class ModelBase implements Serializable {
    ...
    private static String executeRequest(HttpUriRequest request) {
        ...
        Log.i(AppConstant.DEBUG, "============================================");
        for (Header h : request.getAllHeaders()) {
            Log.d(AppConstant.DEBUG, String.format("%s -> %s", h.getName(), h.getValue()));
        }
        Log.d(AppConstant.DEBUG, request.getURI().toString());
        try {
        ...
        String response = "";
        Log.d(AppConstant.DEBUG,"Status code: "+httpResponse.getStatusLine().getStatusCode());
        ...
        try {
            ...
            Log.d(AppConstant.DEBUG, "Failed to consume entity", e);
        }
        Log.i(AppConstant.DEBUG, response);
        Log.i(AppConstant.DEBUG, "============================================");
        return response;
    }

    protected static String get(String url, Header header) {
        HttpGet httpGet = new HttpGet(url);
